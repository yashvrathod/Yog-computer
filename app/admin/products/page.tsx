...
import { Plus, Search, MoreHorizontal, Pencil, Trash2, Eye, EyeOff, DollarSign } from "lucide-react"
  ...
  async function loadData() {
    try {
      ...
      const [productsResult, categoriesData] = await Promise.all([
        getAdminProducts({ search: searchQuery, category: selectedCategory || undefined }),
        getCategories()
      ])
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleCreateProduct} className="space-y-6 mt-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="features" name="features" placeholder="Feature 1, Feature 2, Feature 3" />
              </div>

              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2">
                  <input type="checkbox" id="showPrice" name="showPrice" className="rounded" defaultChecked />
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  name="category"
                  className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm"
                  defaultValue={typeof editingProduct?.category === 'object' ? editingProduct?.category?.id : ''}
                >
                  <option value="">No category</option>
                  {categories.map((cat) => (
                    <option key={cat.id} value={cat.id}>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  step="0.01" 
                  placeholder="0.00" 
                  defaultValue={editingProduct?.price ? Number(editingProduct.price) : ''}
                />
              </div>
              <div className="space-y-2">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                <input 
                  ...
                  name="showPrice" 
                  className="rounded" 
                  defaultChecked={editingProduct?.showPrice || false}
                />
